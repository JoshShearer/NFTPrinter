...
export const Comps_NFTDisplay = (_props: typeof defaultProps) => {
  ...
  return (
    <div className="Comps_NFTDisplay">
      <Comps_misc_placeholder>
        <p>Comps_NFTDisplay</p>
      </Comps_misc_placeholder>
    </div>
  );
};

// export class Comps_NFTDisplay extends React.PureComponent<Props> {
// 	render() {
// 		const { countState } = this.props
// 		return <div>Comps_NFTDisplay</div>
// 	}
// }
